...
public:
	...
	static std::shared_ptr<Encoder> armarmEnc;
	...
	static std::shared_ptr<DigitalInput> acquisitionacqStop1;
	static std::shared_ptr<DigitalInput> acquisitionacqStop2;
	...
	static std::shared_ptr<Solenoid> driveshift;

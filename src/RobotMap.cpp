...
std::shared_ptr<frc::Encoder> RobotMap::drivelEnc;
std::shared_ptr<frc::Encoder> RobotMap::driverEnc;
std::shared_ptr<CANTalon> RobotMap::acquisitionacqRoller;
std::shared_ptr<frc::DigitalInput> RobotMap::acquisitionacqSensor1;
std::shared_ptr<frc::DigitalInput> RobotMap::acquisitionacqSensor2;
std::shared_ptr<frc::AnalogPotentiometer> RobotMap::armarmPot;
std::shared_ptr<CANTalon> RobotMap::armarmLift;
std::shared_ptr<frc::DigitalInput> RobotMap::armarmHallTop;
std::shared_ptr<frc::DigitalInput> RobotMap::armarmHallBot;
std::shared_ptr<CANTalon> RobotMap::scalingscaleLift;
std::shared_ptr<frc::Encoder> RobotMap::scalingscaleEnc;
std::shared_ptr<frc::DigitalInput> RobotMap::scalingscaleLimit;
std::shared_ptr<frc::Solenoid> RobotMap::driveshiftGear;
std::shared_ptr<frc::Solenoid> RobotMap::armarmAssist;
...
void RobotMap::init() {
    ...
    drivelDrive2->SetControlMode(frc::CANSpeedController::ControlMode::kFollower);
    drivelDrive2->Set(DRV_L1);

    driverDrive2->SetControlMode(frc::CANSpeedController::ControlMode::kFollower);
    ...
    driverDrive1->SetPIDSourceType(frc::PIDSourceType::kRate);
    drivelDrive1->SetPIDSourceType(frc::PIDSourceType::kRate);
...
//    driverEnc->SetPIDSourceType(PIDSourceType::kRate);
    ...
    acquisitionacqSensor1.reset(new frc::DigitalInput(ACQ_DI1));
    lw->AddSensor("Acquisition", "acqSensor1", acquisitionacqSensor1);
    
    acquisitionacqSensor2.reset(new frc::DigitalInput(ACQ_DI2));
    lw->AddSensor("Acquisition", "acqSensor2", acquisitionacqSensor2);
    
    armarmPot.reset(new frc::AnalogPotentiometer(ARM_POT, 4096.0, 0.0));
    lw->AddSensor("Arm", "armPot", armarmPot);
    
    armarmLift.reset(new CANTalon(ARM_LIFT));
    armarmLift->SetPIDSourceType(frc::PIDSourceType::kDisplacement);
    armarmLift->SetFeedbackDevice(CANTalon::FeedbackDevice::AnalogPot);
    ((std::shared_ptr<frc::CANSpeedController>)armarmLift)->SetPID(ARM_LIFT_P, ARM_LIFT_I, ARM_LIFT_D);
    ...
    armarmHallTop.reset(new frc::DigitalInput(ARM_HALL_TOP));
    lw->AddSensor("Arm", "armHallTop", armarmHallTop);
    
    armarmHallBot.reset(new frc::DigitalInput(ARM_HALL_BOT));
...
//    scalingscaleEnc->SetPIDSourceType(PIDSourceType::kDisplacement);
    ...
    scalingscaleLimit.reset(new frc::DigitalInput(SCL_LMT));
    lw->AddSensor("Scaling", "scaleLimit", scalingscaleLimit);
    
    scalingscaleLift->ConfigEncoderCodesPerRev(4096);

    scalingscaleLift->SetPIDSourceType(frc::PIDSourceType::kDisplacement);
    ((std::shared_ptr<frc::CANSpeedController>)scalingscaleLift)->SetPID(SCL_LIFT_P,SCL_LIFT_I,SCL_LIFT_D);

    driveshiftGear.reset(new frc::Solenoid(DRV_SHIFT));

    armarmAssist.reset(new frc::Solenoid(ARM_ASSIST));

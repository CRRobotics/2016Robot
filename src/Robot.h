...
public:
    ...
    static frc::SendableChooser<Command> * autoPositionChooser;
    static frc::SendableChooser<Command> * autoDefenseChooser;
    static frc::SendableChooser<Command> * autoActionChooser;

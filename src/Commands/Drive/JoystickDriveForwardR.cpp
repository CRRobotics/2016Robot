...
#include "JoystickDriveForwardR.h"

// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR

JoystickDriveForwardR::JoystickDriveForwardR(): Command() {
...
bool JoystickDriveForwardR::IsFinished() {
    return false;
}

// Called once after isFinished returns true
void JoystickDriveForwardR::End() {

}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void JoystickDriveForwardR::Interrupted() {
